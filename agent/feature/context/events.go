// Package context — стратегии управления контекстом диалога.
//
// Отвечает за то, КАКИЕ сообщения короткого (short-term) слоя памяти уходят в
// запрос к LLM: скользящее окно, ветвление или «недавние с рабочим контекстом».
// Память многослойная живёт в пакете feature/memory; здесь — только диалоговое
// окно и события стратегий.
package context
